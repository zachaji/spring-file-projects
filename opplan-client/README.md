...
Angular client application for downloading files from AWS S3 via the Opplan Service (Spring Boot backend).
...
Ensure the Spring Boot backend (opplan-service) is running on `http://localhost:8080`
...
1. Make sure the Spring Boot backend (opplan-service) is running on port 8080
